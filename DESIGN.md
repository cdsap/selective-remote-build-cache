...
Background for [selective-remote-build-cache](README.md): how the delegation works, how the task
type is recovered from build operations, what the test suite pins down, and the known limitations.
Read the README first if you just want to use the plugin.
